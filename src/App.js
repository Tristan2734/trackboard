              ...
              {libreExos.map((e,i)=>(
                <div key={i} style={{padding:"10px",borderRadius:10,background:C.alt,marginBottom:6}}>
                  <div style={{display:"flex",gap:6,marginBottom:8,alignItems:"flex-start"}}>
                    <textarea value={e.nom} onChange={ev=>updLibreExo(i,"nom",ev.target.value)} placeholder="Exercice" className="inp" style={{flex:1,minWidth:0,minHeight:"50px",padding:"8px",resize:"none",fontFamily:"inherit"}}/>
          ...
          {exos.map((e,i)=>(
            <div key={i} style={{padding:"12px",borderRadius:12,background:C.alt,marginBottom:8}}>
              <div style={{display:"flex",gap:8,marginBottom:8,alignItems:"flex-start"}}>
                <textarea value={e.nom} onChange={ev=>updExo(i,"nom",ev.target.value)} placeholder="Exercice" className="inp" style={{flex:1,minWidth:0,minHeight:"50px",padding:"8px",resize:"none",fontFamily:"inherit"}}/>
