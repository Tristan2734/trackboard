              ...
              {libreExos.map((e,i)=>(
                <div key={i} style={{padding:"10px",borderRadius:10,background:C.alt,marginBottom:6}}>
                  <div style={{position:"relative",marginBottom:8}}>
                    <div contentEditable suppressContentEditableWarning onInput={ev=>updLibreExo(i,"nom",ev.currentTarget.textContent)} style={{width:"100%",minHeight:"80px",padding:"8px 32px 8px 8px",fontFamily:"inherit",boxSizing:"border-box",border:`1px solid ${C.border}`,borderRadius:8,background:C.surface,color:C.text,fontSize:14,whiteSpace:"pre-wrap",wordWrap:"break-word",outline:"none"}}>{e.nom}</div>
        ...
        <>
          ...
          {exos.map((e,i)=>(
            <div key={i} style={{padding:"12px",borderRadius:12,background:C.alt,marginBottom:8}}>
              <div style={{position:"relative",marginBottom:8}}>
                <div contentEditable suppressContentEditableWarning onInput={ev=>updExo(i,"nom",ev.currentTarget.textContent)} style={{width:"100%",minHeight:"80px",padding:"8px 32px 8px 8px",fontFamily:"inherit",boxSizing:"border-box",border:`1px solid ${C.border}`,borderRadius:8,background:C.surface,color:C.text,fontSize:14,whiteSpace:"pre-wrap",wordWrap:"break-word",outline:"none"}}>{e.nom}</div>
